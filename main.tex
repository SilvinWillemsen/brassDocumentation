...
\begin{figure}[ht]
    ...
    % draw mass
    \node at (0,0) [rectangle,draw, minimum height=1cm,minimum width= \massWidth cm] (M) {$M$};

    \draw[-] (-0.5 * \massWidth, 0.5) -- (-0.5, 0.5 * \massWidth) node[] () {};

    \draw[-] (0.5 * \massWidth, 0.5) -- (2.5, 0.5 * \massWidth) node[] () {};

    \draw[-] (-0.5, 0.5 * \massWidth) -- (2.5, 0.5 * \massWidth) node[] () {};

    \draw[-] (2.5, 0.5) -- (2.5, 0.5 * \massWidth) node[] () {};

    \draw[-] (2.5, 0.5) -- (2.5, 0.5 * \massWidth) node[] () {};

    \draw[-] (0.5 * \massWidth, -0.5) -- (2.5, 0.5) node[] () {};

    \node[rotate = 0] at (0.5, 1) (Sr) {$S_\text{r}$};

    % draw spring
    \filldraw[gray] (-0.5, 2.5) circle (1pt) node[anchor=center](topSpring){};    
    \draw[-, color = gray] (-0.5, 2.5) -- (-0.5, 2.3);
    \draw[-, color = gray] (-0.5, 2.3) -- (-0.75, 2.2);
    %switched these around because of the color
    \draw[-] (-0.25, 2.02) -- (-0.75, 1.84);
    \draw[-, color = gray] (-0.75, 2.2) -- (-0.25, 2.02);
    \draw[-] (-0.75, 1.84) -- (-0.25, 1.66);
    \draw[-] (-0.25, 1.66) -- (-0.75, 1.52);
    \draw[-] (-0.75, 1.52) -- (-0.25, 1.3);
    \draw[-] (-0.25, 1.3) -- (-0.5, 1.2);
    \draw[-] (-0.5, 1.2) -- (-0.5, 1.0);
    \filldraw[black] (-0.5, 1.0) circle (1pt) node[anchor=center](bottomSpring){};    
    \node at (-1, 1.75) (K) {$K$};
    
    % draw dashpot
    \filldraw[gray] (1.5, 2.5) circle (1pt) node[anchor=center](topDashPot){};
    \draw[-, color = gray] (1.5, 2.5) -- (1.5, 2);
    \draw[-] (1.5, 2) -- (1.5, 1.4);

    \draw[-] (1.3, 1.4) -- (1.7, 1.4);

    \draw[-] (1.25, 1.7) -- (1.25, 1.35);
    \draw[-] (1.75, 1.35) -- (1.75, 1.7);

    \draw[-] (1.25, 1.35) -- (1.75, 1.35);
    \draw[-] (1.5, 1.35) -- (1.5, 1.0);

    \filldraw[black] (1.5, 1.0) circle (1pt) node[anchor=center](bottomDashpot){};    

    \node at (1.0, 1.75) (sigma) {$\sigma$};
...
\begin{subnumcases}{\label{eq:discreteLipSystem}}
    ...
    U_\text{B}^{n+1/2} & $= w[y^{n+1/2}+H_0]_+\text{sgn}(\Delta p^{n+1/2})\sqrt{\frac{2|\Delta p^{n+1/2}|}{\rho_0}}$\\
    U_\text{r}^{n+1/2} & $= S_\text{r}\delta_{t\cdot}y^{n+1/2}$\\
